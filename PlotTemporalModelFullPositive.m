function PlotTemporalModelFullPositive(results)
% PlotTemporalModelFullPositive Generate diagnostic plots for TemporalModelFullPositive results.
%
%   PlotTemporalModelFullPositive(results)
%       results - Output struct returned by TemporalModelFullPositive containing
...
if nargin < 1 || isempty(results)
    error('PlotTemporalModelFullPositive:MissingResults', ...
        'Results struct from TemporalModelFullPositive is required.');
end

fprintf('\nGenerating positive-peak plots...\n');
